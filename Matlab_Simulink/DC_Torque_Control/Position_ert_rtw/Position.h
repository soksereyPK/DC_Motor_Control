...
typedef struct {
  ...
  codertarget_arduinobase_block_T obj_l;/* '<S1>/Digital Output1' */
  codertarget_arduinobase_block_T obj_n;/* '<S1>/Digital Output' */
  codertarget_arduinobase_int_c_T obj_no;/* '<S1>/PWM' */
 ...
 *
 * '<Root>' : 'Position'
 * '<S1>'   : 'Position/Right motor2'
 * '<S2>'   : 'Position/Right motor2/MATLAB Function4'
 * '<S3>'   : 'Position/Right motor2/Radians to Degrees'
 */
