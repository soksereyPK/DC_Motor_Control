 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jun 28 16:26:58 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME readEncDUEpin10_11
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    readEncDUEpin10_11_Start_wrapper(xD);
}
#endif /*  MDL_START */
...
{
    int32_T *countt = (int32_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    readEncDUEpin10_11_Outputs_wrapper(countt, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    readEncDUEpin10_11_Update_wrapper(countt, xD);
