 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jun 28 16:26:39 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME readEncDUEpin8_9
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    readEncDUEpin8_9_Start_wrapper(xD);
}
#endif /*  MDL_START */
...
{
    int32_T *count = (int32_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    readEncDUEpin8_9_Outputs_wrapper(count, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    readEncDUEpin8_9_Update_wrapper(count, xD);
