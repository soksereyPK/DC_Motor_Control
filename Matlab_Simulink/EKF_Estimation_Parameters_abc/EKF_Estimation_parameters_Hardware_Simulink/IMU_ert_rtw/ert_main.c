...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T) ((IMU_M->Timing.clockTick0 * 1) + 0)
    ;
  IMU_step0();
  ...
  if (need2runFlags[2]) {
    ...
    {
     case 2 :
      currentTime = (extmodeSimulationTime_T) ((IMU_M->Timing.clockTick2 * 10) +
        0)
        ;
      IMU_step2();
...
int main(void)
{
  ...
  errorCode = extmodeInit(IMU_M->extModeInfo, &rtmGetTFinal(IMU_M));
  if (errorCode != EXTMODE_SUCCESS) {
