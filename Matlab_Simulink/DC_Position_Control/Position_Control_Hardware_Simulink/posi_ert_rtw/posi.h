...
#ifndef RTW_HEADER_posi_h_
#define RTW_HEADER_posi_h_
#ifndef posi_COMMON_INCLUDES_
#define posi_COMMON_INCLUDES_
#include "rtwtypes.h"
...
typedef struct {
  ...
  codertarget_arduinobase_int_j_T obj_h;/* '<S1>/PWM2' */
  codertarget_arduinobase_int_j_T obj_o;/* '<S1>/PWM1' */
  ...
  real_T TimeStampA_i;                 /* '<Root>/Derivative7' */
  real_T LastUAtTimeA_f;               /* '<Root>/Derivative7' */
  real_T TimeStampB_a;                 /* '<Root>/Derivative7' */
  real_T LastUAtTimeB_d;               /* '<Root>/Derivative7' */
  ...
  real_T TimeStampA_in;                /* '<Root>/Derivative1' */
...
extern P_posi_T posi_P;

/* Block signals (default storage) */
extern B_posi_T posi_B;

/* Block states (default storage) */
extern DW_posi_T posi_DW;

/* Model entry point functions */
extern void posi_initialize(void);
extern void posi_step(void);
extern void posi_terminate(void);

/* Real-time Model object */
extern RT_MODEL_posi_T *const posi_M;
 ...
 *
 * '<Root>' : 'posi'
 * '<S1>'   : 'posi/Right motor1'
 * '<S2>'   : 'posi/Right motor1/MATLAB Function1'
 */
#endif                                 /* RTW_HEADER_posi_h_ */
