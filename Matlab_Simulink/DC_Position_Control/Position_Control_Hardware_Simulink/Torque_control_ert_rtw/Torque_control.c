...
void Torque_control_initialize(void)
{
  ...
  /* External mode info */
  Torque_control_M->Sizes.checksums[0] = (755708915U);
  Torque_control_M->Sizes.checksums[1] = (3136558119U);
  Torque_control_M->Sizes.checksums[2] = (2522847278U);
  Torque_control_M->Sizes.checksums[3] = (1625137914U);
