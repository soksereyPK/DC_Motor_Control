...
void Torque_control_initialize(void)
{
  ...
  /* External mode info */
  Torque_control_M->Sizes.checksums[0] = (3234556826U);
  Torque_control_M->Sizes.checksums[1] = (2422588273U);
  Torque_control_M->Sizes.checksums[2] = (2291395446U);
  Torque_control_M->Sizes.checksums[3] = (3474105352U);
