...
/* Custom Type definition for MATLABSystem: '<S2>/Calibration write' */
#include "MW_SVD.h"
...
typedef struct tag_hiATgaifu8RfrjZ2yifYbH codertarget_arduinobase_int_d_T;
...
typedef struct tag_chY474Xs2EmAHQmJ9UhmtD codertarget_arduinobase_in_dv_T;
...
#ifndef typedef_codertarget_arduinobase_i_dvd_T
#define typedef_codertarget_arduinobase_i_dvd_T

typedef struct tag_4eDVzK5FiryyCjvjjvrZGB codertarget_arduinobase_i_dvd_T;

#endif                             /* typedef_codertarget_arduinobase_i_dvd_T */
